import { ProjectEnergyCollection } from '../content/energie/collection';
...
export default [HomeCollection, ArticlesCollection, DocumentsCollection, ProjectEnergyCollection];
